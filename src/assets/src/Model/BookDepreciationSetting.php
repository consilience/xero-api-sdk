...
class BookDepreciationSetting implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    {
        $this->container['depreciationMethod'] = isset($data['depreciationMethod']) ? $data['depreciationMethod'] : null;
        $this->container['averagingMethod'] = isset($data['averagingMethod']) ? $data['averagingMethod'] : null;
        $this->container['depreciationRate'] = isset($data['depreciationRate']) ? $data['depreciationRate'] : null;
        $this->container['effectiveLifeYears'] = isset($data['effectiveLifeYears']) ? $data['effectiveLifeYears'] : null;
        $this->container['depreciationCalculationMethod'] = isset($data['depreciationCalculationMethod']) ? $data['depreciationCalculationMethod'] : null;
    }
    ...
    {
        return $this->container['depreciationMethod'];
    }
    ...
    {
        return $this->container['averagingMethod'];
    }
    ...
    {
        return $this->container['depreciationRate'];
    }
    ...
    {
        return $this->container['effectiveLifeYears'];
    }
    ...
    {
        return $this->container['depreciationCalculationMethod'];
    }
