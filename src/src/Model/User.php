...
class User implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['isSubscriber'] = isset($data['isSubscriber']) ? $data['isSubscriber'] : null;
        $this->container['organisationRole'] = isset($data['organisationRole']) ? $data['organisationRole'] : null;
    }
     ...
     * Sets updatedDateUTC
     *
     * @param \DateTime|null $updatedDateUTC Last name of user
     *
     * @return $this
     */
    ...
    {
        return $this->container['isSubscriber'];
    }
    ...
    {
        return $this->container['organisationRole'];
    }

    /**
     * Sets organisationRole
     *
     * @param string|null $organisationRole Boolean to indicate if user is the subscriber
     *
     * @return $this
     */
