...
class ManualJournalLine implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'taxType' => 'string',
        'tracking' => '\Consilience\XeroAccounting\Sdk\Model\TrackingCategory[]',
        'taxAmount' => 'double',
        'isBlank' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['isBlank'] = isset($data['isBlank']) ? $data['isBlank'] : null;
    }
     ...
     * Sets tracking
     *
     * @param \Consilience\XeroAccounting\Sdk\Model\TrackingCategory[]|null $tracking Optional Tracking Category – see Tracking. Any JournalLine can have a maximum of 2 <TrackingCategory> elements.
     *
     * @return $this
     */
