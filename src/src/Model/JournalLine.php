...
class JournalLine implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'accountID' => 'string',
        'accountCode' => 'string',
        'accountType' => '\Consilience\XeroAccounting\Sdk\Model\AccountType',
        'accountName' => 'string',
        'description' => 'string',
        'netAmount' => 'double',
        'grossAmount' => 'double',
        ...
        'taxType' => 'string',
        'taxName' => 'string',
        'trackingCategories' => '\Consilience\XeroAccounting\Sdk\Model\TrackingCategory[]'
    ];
     ...
     * Sets accountType
     *
     * @param \Consilience\XeroAccounting\Sdk\Model\AccountType|null $accountType accountType
     *
     * @return $this
     */
     ...
     *
     * @param \Consilience\XeroAccounting\Sdk\Model\TrackingCategory[]|null $trackingCategories Optional Tracking Category – see Tracking. Any JournalLine can have a maximum of 2 <TrackingCategory> elements.
     *
     * @return $this
     */
