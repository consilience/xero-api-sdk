...
class BatchPayment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['batchPaymentID'] = isset($data['batchPaymentID']) ? $data['batchPaymentID'] : null;
        $this->container['dateString'] = isset($data['dateString']) ? $data['dateString'] : null;
    ...
    {
        return $this->container['batchPaymentID'];
    }
    ...
    {
        return $this->container['dateString'];
    }
     ...
     * Sets payments
     *
     * @param \Consilience\XeroAccounting\Sdk\Model\Payment[]|null $payments payments
     *
     * @return $this
     */
