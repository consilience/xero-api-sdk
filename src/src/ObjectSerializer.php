...
use Consilience\XeroAccounting\Sdk\Model\ModelInterface;
...
class ObjectSerializer
{
        ...
        if (null === $data) {
            ...
            if (! empty($class::DISCRIMINATOR)) {
                ...
                if (is_string($discriminatorName)) {
                    $subclass = '\Consilience\XeroAccounting\Sdk\Model\\' . $discriminatorName;
     ...
     */
    protected static function dataElement($data, string $name)
    {
        if (is_array($data)) {
