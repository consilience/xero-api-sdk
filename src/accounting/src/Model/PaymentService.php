...
class PaymentService implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    {
        $this->container['paymentServiceID'] = $data['paymentServiceID'] ?? null;
        $this->container['paymentServiceName'] = $data['paymentServiceName'] ?? null;
        $this->container['paymentServiceUrl'] = $data['paymentServiceUrl'] ?? null;
        $this->container['payNowText'] = $data['payNowText'] ?? null;
        $this->container['paymentServiceType'] = $data['paymentServiceType'] ?? null;
    ...
    {
        return $this->get('paymentServiceID');
    }
    ...
    {
        return $this->get('paymentServiceName');
    }
    ...
    {
        return $this->get('paymentServiceUrl');
    }
    ...
    {
        return $this->get('paymentServiceType');
    }
