...
class CISOrgSetting implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    {
        $this->container['cISContractorEnabled'] = isset($data['cISContractorEnabled']) ? $data['cISContractorEnabled'] : null;
        $this->container['cISSubContractorEnabled'] = isset($data['cISSubContractorEnabled']) ? $data['cISSubContractorEnabled'] : null;
    ...
    {
        return $this->container['cISContractorEnabled'];
    }
    ...
    {
        return $this->container['cISSubContractorEnabled'];
    }
