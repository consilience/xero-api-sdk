...
/**
 * PayslipReimbursementLine Class Doc Comment
 *
 * @category Class
 * @package  Consilience\Xero\PayrollAuSdk
 * @author   OpenAPI Generator team <team@openapitools.org>
 * @link     https://openapi-generator.tech
 */
class PayslipReimbursementLine implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payslip_ReimbursementLine';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['expenseAccount'] = $data['expenseAccount'] ?? null;
     ...
     *
     * @param string|null $reimbursementTypeID Xero identifier for payroll reimbursement type.
     *
     * @return $this
     */
    ...
    public function setDescription($description)
    {
        if (! is_null($description) && (mb_strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PayslipReimbursementLine., must be smaller than or equal to 50.');
        }
    ...
    {
        return $this->get('expenseAccount');
    }

    /**
     * Sets expenseAccount
     *
     * @param string|null $expenseAccount Reimbursement expense account. For posted pay run you should be able to see expense account code.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Reimbursement amount
     *
     * @return $this
     */
