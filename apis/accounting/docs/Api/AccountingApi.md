# Consilience\Xero\AccountingSdk\AccountingApi
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords createReceiptHistory($receiptID, $historyRecords)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments createRepeatingInvoiceAttachmentByFileName($repeatingInvoiceID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords createRepeatingInvoiceHistory($repeatingInvoiceID, $historyRecords)
...
> \Consilience\Xero\AccountingSdk\Model\TaxRates createTaxRate($taxRates)
...
$taxRates = { "TaxRates":[ { "Name":"SDKTax29067", "TaxComponents":[ { "Name":"State Tax", "Rate":2.25 } ], "ReportTaxType":"INPUT" } ] }; // \Consilience\Xero\AccountingSdk\Model\TaxRates | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **taxRates** | [**\Consilience\Xero\AccountingSdk\Model\TaxRates**](../Model/TaxRates.md)|  |

### Return type

[**\Consilience\Xero\AccountingSdk\Model\TaxRates**](../Model/TaxRates.md)
...
> \Consilience\Xero\AccountingSdk\Model\TrackingCategories createTrackingCategory($trackingCategory)
...
$trackingCategory = { "Name":"FooBar" }; // \Consilience\Xero\AccountingSdk\Model\TrackingCategory | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **trackingCategory** | [**\Consilience\Xero\AccountingSdk\Model\TrackingCategory**](../Model/TrackingCategory.md)|  |

### Return type

[**\Consilience\Xero\AccountingSdk\Model\TrackingCategories**](../Model/TrackingCategories.md)
...
> \Consilience\Xero\AccountingSdk\Model\TrackingOptions createTrackingOptions($trackingCategoryID, $trackingOption)
...
$trackingOption = { "Name":"Bar40423" }; // \Consilience\Xero\AccountingSdk\Model\TrackingOption | 
 ...
 **trackingOption** | [**\Consilience\Xero\AccountingSdk\Model\TrackingOption**](../Model/TrackingOption.md)|  |

### Return type

[**\Consilience\Xero\AccountingSdk\Model\TrackingOptions**](../Model/TrackingOptions.md)
...
> \Consilience\Xero\AccountingSdk\Model\Accounts deleteAccount($accountID)
...
> \Consilience\Xero\AccountingSdk\Model\Payments deletePayment($paymentID, $payments)
...
$paymentID = 'paymentID_example'; // string | Unique identifier for a Payment
$payments = { "Payments":[ { "Status":"DELETED" } ] }; // \Consilience\Xero\AccountingSdk\Model\Payments | 
...
> \Consilience\Xero\AccountingSdk\Model\TrackingCategories deleteTrackingCategory($trackingCategoryID)
...
> \Consilience\Xero\AccountingSdk\Model\TrackingOptions deleteTrackingOptions($trackingCategoryID, $trackingOptionID)
...
$invoiceID = 'invoiceID_example'; // string | Unique identifier for an Invoice
$requestEmpty = new \Consilience\Xero\AccountingSdk\Model\RequestEmpty(); // \Consilience\Xero\AccountingSdk\Model\RequestEmpty | 
...
------------- | ------------- | ------------- | -------------
 **invoiceID** | [**string**](../Model/.md)| Unique identifier for an Invoice |
 **requestEmpty** | [**\Consilience\Xero\AccountingSdk\Model\RequestEmpty**](../Model/RequestEmpty.md)|  |
...
> \Consilience\Xero\AccountingSdk\Model\Accounts getAccount($accountID)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getAccountAttachments($accountID)
...
> \Consilience\Xero\AccountingSdk\Model\Accounts getAccounts($ifModifiedSince, $where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\BankTransactions getBankTransaction($bankTransactionID)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getBankTransactionAttachments($bankTransactionID)
...
> \Consilience\Xero\AccountingSdk\Model\BankTransactions getBankTransactions($ifModifiedSince, $where, $order, $page, $unitdp)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getBankTransactionsHistory($bankTransactionID)
...
> \Consilience\Xero\AccountingSdk\Model\BankTransfers getBankTransfer($bankTransferID)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getBankTransferAttachments($bankTransferID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getBankTransferHistory($bankTransferID)
...
> \Consilience\Xero\AccountingSdk\Model\BankTransfers getBankTransfers($ifModifiedSince, $where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getBatchPaymentHistory($batchPaymentID)
...
> \Consilience\Xero\AccountingSdk\Model\BatchPayments getBatchPayments($ifModifiedSince, $where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\BrandingThemes getBrandingTheme($brandingThemeID)
...
[**\Consilience\Xero\AccountingSdk\Model\BrandingThemes**](../Model/BrandingThemes.md)
...
> \Consilience\Xero\AccountingSdk\Model\PaymentServices getBrandingThemePaymentServices($brandingThemeID)
...
> \Consilience\Xero\AccountingSdk\Model\BrandingThemes getBrandingThemes()
...
> \Consilience\Xero\AccountingSdk\Model\Contacts getContact($contactID)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getContactAttachments($contactID)
...
> \Consilience\Xero\AccountingSdk\Model\CISSettings getContactCISSettings($contactID)
...
[**\Consilience\Xero\AccountingSdk\Model\CISSettings**](../Model/CISSettings.md)
...
> \Consilience\Xero\AccountingSdk\Model\ContactGroups getContactGroup($contactGroupID)
...
> \Consilience\Xero\AccountingSdk\Model\ContactGroups getContactGroups($where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getContactHistory($contactID)
...
> \Consilience\Xero\AccountingSdk\Model\Contacts getContacts($ifModifiedSince, $where, $order, $iDs, $page, $includeArchived)
...
> \Consilience\Xero\AccountingSdk\Model\CreditNotes getCreditNote($creditNoteID)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getCreditNoteAttachments($creditNoteID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getCreditNoteHistory($creditNoteID)
...
> \Consilience\Xero\AccountingSdk\Model\CreditNotes getCreditNotes($ifModifiedSince, $where, $order, $page)
...
> \Consilience\Xero\AccountingSdk\Model\Currencies getCurrencies($where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\Employees getEmployee($employeeID)
...
> \Consilience\Xero\AccountingSdk\Model\Employees getEmployees($ifModifiedSince, $where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\ExpenseClaims getExpenseClaim($expenseClaimID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getExpenseClaimHistory($expenseClaimID)
...
> \Consilience\Xero\AccountingSdk\Model\ExpenseClaims getExpenseClaims($ifModifiedSince, $where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\Invoices getInvoice($invoiceID)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getInvoiceAttachments($invoiceID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getInvoiceHistory($invoiceID)
...
> \Consilience\Xero\AccountingSdk\Model\InvoiceReminders getInvoiceReminders()
...
[**\Consilience\Xero\AccountingSdk\Model\InvoiceReminders**](../Model/InvoiceReminders.md)
...
> \Consilience\Xero\AccountingSdk\Model\Invoices getInvoices($ifModifiedSince, $where, $order, $iDs, $invoiceNumbers, $contactIDs, $statuses, $page, $includeArchived, $createdByMyApp, $unitdp)
...
> \Consilience\Xero\AccountingSdk\Model\Items getItem($itemID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getItemHistory($itemID)
...
> \Consilience\Xero\AccountingSdk\Model\Items getItems($ifModifiedSince, $where, $order, $unitdp)
...
> \Consilience\Xero\AccountingSdk\Model\Journals getJournal($journalID)
...
[**\Consilience\Xero\AccountingSdk\Model\Journals**](../Model/Journals.md)
...
> \Consilience\Xero\AccountingSdk\Model\Journals getJournals($ifModifiedSince, $offset, $paymentsOnly)
...
> \Consilience\Xero\AccountingSdk\Model\LinkedTransactions getLinkedTransaction($linkedTransactionID)
...
> \Consilience\Xero\AccountingSdk\Model\LinkedTransactions getLinkedTransactions($page, $linkedTransactionID, $sourceTransactionID, $contactID, $status, $targetTransactionID)
...
> \Consilience\Xero\AccountingSdk\Model\ManualJournals getManualJournal($manualJournalID)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getManualJournalAttachments($manualJournalID)
...
> \Consilience\Xero\AccountingSdk\Model\ManualJournals getManualJournals($ifModifiedSince, $where, $order, $page)
...
> \Consilience\Xero\AccountingSdk\Model\OnlineInvoices getOnlineInvoice($invoiceID)
...
[**\Consilience\Xero\AccountingSdk\Model\OnlineInvoices**](../Model/OnlineInvoices.md)
...
> \Consilience\Xero\AccountingSdk\Model\CISOrgSetting getOrganisationCISSettings($organisationID)
...
[**\Consilience\Xero\AccountingSdk\Model\CISOrgSetting**](../Model/CISOrgSetting.md)
...
> \Consilience\Xero\AccountingSdk\Model\Organisations getOrganisations()
...
[**\Consilience\Xero\AccountingSdk\Model\Organisations**](../Model/Organisations.md)
...
> \Consilience\Xero\AccountingSdk\Model\Overpayments getOverpayment($overpaymentID)
...
[**\Consilience\Xero\AccountingSdk\Model\Overpayments**](../Model/Overpayments.md)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getOverpaymentHistory($overpaymentID)
...
> \Consilience\Xero\AccountingSdk\Model\Overpayments getOverpayments($ifModifiedSince, $where, $order, $page, $unitdp)
...
> \Consilience\Xero\AccountingSdk\Model\Payments getPayment($paymentID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getPaymentHistory($paymentID)
...
> \Consilience\Xero\AccountingSdk\Model\PaymentServices getPaymentServices()
...
> \Consilience\Xero\AccountingSdk\Model\Payments getPayments($ifModifiedSince, $where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\Prepayments getPrepayment($prepaymentID)
...
[**\Consilience\Xero\AccountingSdk\Model\Prepayments**](../Model/Prepayments.md)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getPrepaymentHistory($prepaymentID)
...
> \Consilience\Xero\AccountingSdk\Model\Prepayments getPrepayments($ifModifiedSince, $where, $order, $page, $unitdp)
...
> \Consilience\Xero\AccountingSdk\Model\PurchaseOrders getPurchaseOrder($purchaseOrderID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getPurchaseOrderHistory($purchaseOrderID)
...
> \Consilience\Xero\AccountingSdk\Model\PurchaseOrders getPurchaseOrders($ifModifiedSince, $status, $dateFrom, $dateTo, $order, $page)
...
> \Consilience\Xero\AccountingSdk\Model\Receipts getReceipt($receiptID)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getReceiptAttachments($receiptID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getReceiptHistory($receiptID)
...
> \Consilience\Xero\AccountingSdk\Model\Receipts getReceipts($ifModifiedSince, $where, $order, $unitdp)
...
> \Consilience\Xero\AccountingSdk\Model\RepeatingInvoices getRepeatingInvoice($repeatingInvoiceID)
...
[**\Consilience\Xero\AccountingSdk\Model\RepeatingInvoices**](../Model/RepeatingInvoices.md)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments getRepeatingInvoiceAttachments($repeatingInvoiceID)
...
> \Consilience\Xero\AccountingSdk\Model\HistoryRecords getRepeatingInvoiceHistory($repeatingInvoiceID)
...
> \Consilience\Xero\AccountingSdk\Model\RepeatingInvoices getRepeatingInvoices($where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportAgedPayablesByContact($contactId, $date, $fromDate, $toDate)
...
[**\Consilience\Xero\AccountingSdk\Model\ReportWithRows**](../Model/ReportWithRows.md)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportAgedReceivablesByContact($contactId, $date, $fromDate, $toDate)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportBASorGST($reportID)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportBASorGSTList()
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportBalanceSheet($date, $periods, $timeframe, $trackingOptionID1, $trackingOptionID2, $standardLayout, $paymentsOnly)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportBankSummary($date, $period, $timeframe)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportBudgetSummary($date, $period, $timeframe)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportExecutiveSummary($date)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportProfitAndLoss($fromDate, $toDate, $periods, $timeframe, $trackingCategoryID, $trackingCategoryID2, $trackingOptionID, $trackingOptionID2, $standardLayout, $paymentsOnly)
...
> \Consilience\Xero\AccountingSdk\Model\Reports getReportTenNinetyNine($reportYear)
...
[**\Consilience\Xero\AccountingSdk\Model\Reports**](../Model/Reports.md)
...
> \Consilience\Xero\AccountingSdk\Model\ReportWithRows getReportTrialBalance($date, $paymentsOnly)
...
> \Consilience\Xero\AccountingSdk\Model\TaxRates getTaxRates($where, $order, $taxType)
...
> \Consilience\Xero\AccountingSdk\Model\TrackingCategories getTrackingCategories($where, $order, $includeArchived)
...
> \Consilience\Xero\AccountingSdk\Model\TrackingCategories getTrackingCategory($trackingCategoryID)
...
> \Consilience\Xero\AccountingSdk\Model\Users getUser($userID)
...
[**\Consilience\Xero\AccountingSdk\Model\Users**](../Model/Users.md)
...
> \Consilience\Xero\AccountingSdk\Model\Users getUsers($ifModifiedSince, $where, $order)
...
> \Consilience\Xero\AccountingSdk\Model\Accounts updateAccount($accountID, $accounts)
...
$accountID = 'accountID_example'; // string | Unique identifier for retrieving single object
$accounts = { "Accounts":[ { "Code":"123456", "Name":"BarFoo", "AccountID":"99ce6032-0678-4aa0-8148-240c75fee33a", "Type":"EXPENSE", "Description":"GoodBye World", "TaxType":"INPUT", "EnablePaymentsToAccount":false, "ShowInExpenseClaims":false, "Class":"EXPENSE", "ReportingCode":"EXP", "ReportingCodeName":"Expense", "UpdatedDateUTC":"2019-02-21T16:29:47.96-08:00" } ] }; // \Consilience\Xero\AccountingSdk\Model\Accounts | Request of type Accounts array with one Account
...
------------- | ------------- | ------------- | -------------
 **accountID** | [**string**](../Model/.md)| Unique identifier for retrieving single object |
 **accounts** | [**\Consilience\Xero\AccountingSdk\Model\Accounts**](../Model/Accounts.md)| Request of type Accounts array with one Account |
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateAccountAttachmentByFileName($accountID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\BankTransactions updateBankTransaction($bankTransactionID, $bankTransactions)
...
], "BankAccount":{ "Code":"088", "Name":"Business Wells Fargo", "AccountID":"6f7594f2-f059-4d56-9e67-47ac9733bfe9" }, "IsReconciled":false, "Date":"2019-02-25", "Reference":"You just updated", "CurrencyCode":"USD", "CurrencyRate":1.0, "Status":"AUTHORISED", "LineAmountTypes":"Inclusive", "TotalTax":1.74, "BankTransactionID":"1289c190-e46d-434b-9628-463ffdb52f00", "UpdatedDateUTC":"2019-02-26T12:39:27.813-08:00" } ] }; // \Consilience\Xero\AccountingSdk\Model\BankTransactions | 
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateBankTransactionAttachmentByFileName($bankTransactionID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateBankTransferAttachmentByFileName($bankTransferID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\Contacts updateContact($contactID, $contacts)
...
$contactID = 'contactID_example'; // string | Unique identifier for a Contact
$contacts = { "Contacts":[ { "ContactID":"d5be01fb-b09f-4c3a-9c67-e10c2a03412c", "Name":"FooBar" } ] }; // \Consilience\Xero\AccountingSdk\Model\Contacts | 
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateContactAttachmentByFileName($contactID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\ContactGroups updateContactGroup($contactGroupID, $contactGroups)
...
$contactGroupID = 'contactGroupID_example'; // string | Unique identifier for a Contact Group
$contactGroups = { "ContactGroups":[ { "Name":"Vendor" } ] }; // \Consilience\Xero\AccountingSdk\Model\ContactGroups | 
...
> \Consilience\Xero\AccountingSdk\Model\CreditNotes updateCreditNote($creditNoteID, $creditNotes)
...
$creditNoteID = 'creditNoteID_example'; // string | Unique identifier for a Credit Note
$creditNotes = { "CreditNotes":[ { "Type":"ACCPAYCREDIT", "Contact":{ "ContactID":"430fa14a-f945-44d3-9f97-5df5e28441b8" }, "Date":"2019-01-05", "Status":"AUTHORISED", "Reference": "HelloWorld", "LineItems":[ { "Description":"Foobar", "Quantity":2.0, "UnitAmount":20.0, "AccountCode":"400" } ] } ] }; // \Consilience\Xero\AccountingSdk\Model\CreditNotes | 
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateCreditNoteAttachmentByFileName($creditNoteID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\Employees updateEmployee($employeeID, $employees)
...
$employeeID = 'employeeID_example'; // string | Unique identifier for a Employee
$employees = { "Employees":[ { "EmployeeID":"ad3db144-6362-459c-8c36-5d31d196e629", "FirstName":"Bruce", "LastName":"Banner" } ] }; // \Consilience\Xero\AccountingSdk\Model\Employees | 
...
> \Consilience\Xero\AccountingSdk\Model\ExpenseClaims updateExpenseClaim($expenseClaimID, $expenseClaims)
...
> \Consilience\Xero\AccountingSdk\Model\Invoices updateInvoice($invoiceID, $invoices)
...
], "Reference":"My the Force be With You", "InvoiceID":"4074292c-09b3-456d-84e7-add864c6c39b" } ] }; // \Consilience\Xero\AccountingSdk\Model\Invoices | 
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateInvoiceAttachmentByFileName($invoiceID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\Items updateItem($itemID, $items)
...
$itemID = 'itemID_example'; // string | Unique identifier for an Item
$items = { "Items":[ { "Code":"abc38306", "Description":"Hello Xero" } ] }; // \Consilience\Xero\AccountingSdk\Model\Items | 
...
> \Consilience\Xero\AccountingSdk\Model\LinkedTransactions updateLinkedTransaction($linkedTransactionID, $linkedTransactions)
...
$linkedTransactionID = 'linkedTransactionID_example'; // string | Unique identifier for a LinkedTransaction
$linkedTransactions = { "LinkedTransactions":[ { "ContactID":"4e1753b9-018a-4775-b6aa-1bc7871cfee3" } ] }; // \Consilience\Xero\AccountingSdk\Model\LinkedTransactions | 
...
> \Consilience\Xero\AccountingSdk\Model\ManualJournals updateManualJournal($manualJournalID, $manualJournals)
...
], "ManualJournalID":"07eac261-78ef-47a0-a0eb-a57b74137877" } ] }; // \Consilience\Xero\AccountingSdk\Model\ManualJournals | 
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateManualJournalAttachmentByFileName($manualJournalID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\PurchaseOrders updatePurchaseOrder($purchaseOrderID, $purchaseOrders)
...
], "AttentionTo":"Jimmy" } ] }; // \Consilience\Xero\AccountingSdk\Model\PurchaseOrders | 
...
> \Consilience\Xero\AccountingSdk\Model\Receipts updateReceipt($receiptID, $receipts)
...
], "User":{ "UserID":"d1164823-0ac1-41ad-987b-b4e30fe0b273" }, "Reference":"Foobar" } ] }; // \Consilience\Xero\AccountingSdk\Model\Receipts | 
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateReceiptAttachmentByFileName($receiptID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\Attachments updateRepeatingInvoiceAttachmentByFileName($repeatingInvoiceID, $fileName, $body)
...
> \Consilience\Xero\AccountingSdk\Model\TaxRates updateTaxRate($taxRates)
...
$taxRates = { "TaxRates":[ { "Name":"SDKTax29067", "TaxComponents":[ { "Name":"State Tax", "Rate":2.25 } ], "Status":"DELETED", "ReportTaxType":"INPUT" } ] }; // \Consilience\Xero\AccountingSdk\Model\TaxRates | 
...
> \Consilience\Xero\AccountingSdk\Model\TrackingCategories updateTrackingCategory($trackingCategoryID, $trackingCategory)
...
$trackingCategoryID = 'trackingCategoryID_example'; // string | Unique identifier for a TrackingCategory
$trackingCategory = { "Name":"BarFoo" }; // \Consilience\Xero\AccountingSdk\Model\TrackingCategory | 
