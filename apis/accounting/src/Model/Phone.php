...
class Phone implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    {
        $this->container['phoneType'] = $data['phoneType'] ?? null;
        $this->container['phoneNumber'] = $data['phoneNumber'] ?? null;
        $this->container['phoneAreaCode'] = $data['phoneAreaCode'] ?? null;
        $this->container['phoneCountryCode'] = $data['phoneCountryCode'] ?? null;
    }
