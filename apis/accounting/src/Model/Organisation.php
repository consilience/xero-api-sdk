...
class Organisation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    const ORGANISATION_TYPE_SUPERANNUATION_FUND = 'SUPERANNUATION_FUND';const SALES_TAX_BASIS_PAYMENTS = 'PAYMENTS';
    ...
    const ORGANISATION_ENTITY_TYPE_SUPERANNUATION_FUND = 'SUPERANNUATION_FUND';const MODEL_CLASS_DEMO = 'DEMO';
